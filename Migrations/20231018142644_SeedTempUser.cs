...
{
    /// <inheritdoc />
    public partial class SeedTempUser : Migration
    {
       ...
       table: "Roles",
       columns: new[] { "Id", "UserId", "RoleId" },
       values: new object[] { 1, "898369D1-C0F1-4196-F1EE-08DBCFCC1365", "2" }
   );
 ...
 table: "Roles",
 columns: new[] { "Id", "UserId", "RoleId" },
 values: new object[] { 1, "898369D1-C0F1-4196-F1EE-08DBCFCC1362", "2" }
);
            migrationBuilder.InsertData(
              table: "Users",
              columns: new[] { "Id", "username", "password", "email", "phone", "city", "Address", "DateJoined", "RefreshToken", "DateCreated", "BlackListToken" },
...
table: "Roles",
columns: new[] { "Id", "UserId", "RoleId" },
values: new object[] { 1, "898369D1-C0F1-4196-F1EE-08DBCFCC1360", "2" }
);
        }
