...
namespace Bespeaking__Backup.Migrations
{
    ...
    [Migration("20231023163433_Hotels")]
            ...
            modelBuilder.Entity("Bespeaking.Models.Hotel", b =>
                {
                    ...
                    b.Property<byte[]>("image_5")
                        .IsRequired()
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("image_6")
                        .IsRequired()
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("image_7")
                        .IsRequired()
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("image_8")
                        .IsRequired()
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("image_9")
                        .IsRequired()
                        .HasColumnType("varbinary(max)");
